...
public class AssociateController {
	...
	public ModelAndView registerAssociateAction(@Valid@ModelAttribute Associate associate, BindingResult result) throws PayrollServicesDownException, SQLException {
